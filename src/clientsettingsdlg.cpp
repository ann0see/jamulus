    ...
    pSettings ( pNSetP )
{
    ...
    gbSmallNetworkBuffers->setWhatsThis ( strSmallNetworkBuffersWhatsThis );
    ...
    gbAudioStreamRate->setWhatsThis ( strConnStats );
    ...
    gbFeedBackProtection->setWhatsThis ( strDetectFeedback );
